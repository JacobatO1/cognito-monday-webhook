...
const MONDAY_GROUP_ID = "new_jobs"; // ✅ Group where items will be created
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const itemName = `${BookingReference} - ${PropertyAddress?.FullAddress || "No Address"}`;
    ...
    const columnValues = {
      ...
      no_bedrooms: parseInt(NoOfBedrooms) || 0, // No of Bedrooms (Number)
